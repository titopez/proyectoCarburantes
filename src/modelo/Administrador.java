...
public class Administrador extends Usuario {
    ...
    public Administrador(String nombre, String apellidos, int nit, String cuenta, String contrasenia,String cargo) {
        super(nombre, apellidos, nit, cuenta, contrasenia);
        this.cargo = cargo;
    }
    
    public Administrador(String nombre, String apellidos, int nit, String cuenta, String contrasenia,String cargo, byte tipo) {
